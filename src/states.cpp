...
void states::saveStateToFile(QString filePath)
{
    ...
    {
        out << "-\niwad=" + ui->iwad_comboBox()->currentText() + "\ncomplevel=" + ui->complevel_comboBox()->currentText().mid(0, 2) + "\nwarp1=" + ui->episode_lineEdit()->text() + "\nwarp2=" + level_lineEdit + "\nskill=" + skillbox + "\nbox1=" + bool_cast(ui->toggle1_checkBox()->isChecked()) + "\nbox2=" + bool_cast(ui->toggle2_checkBox()->isChecked()) + "\nbox3=" + bool_cast(ui->toggle3_checkBox()->isChecked()) + "\nbox4=" + bool_cast(ui->toggle4_checkBox()->isChecked()) +
